...
def create_equivalent_price_test_listings():
    ...
    return [
        ...
        Listing(
            id="equiv_daily_1", url="https://test.com/d1", title="Daily 150",
            price=150.0, price_period=PricePeriod.DAY,
            start_date=datetime(2025, 8, 1), end_date=datetime(2025, 9, 1),
            listing_type=ListingType.SUBLET, scraped_at=datetime.utcnow()
        ),
        Listing(
            id="equiv_weekly_1", url="https://test.com/w1", title="Weekly 1050", 
            price=1050.0, price_period=PricePeriod.WEEK,
            start_date=datetime(2025, 8, 1), end_date=datetime(2025, 9, 1),
            listing_type=ListingType.SUBLET, scraped_at=datetime.utcnow()
        ),
        Listing(
            id="equiv_monthly_1", url="https://test.com/m1", title="Monthly 4500",
            price=4500.0, price_period=PricePeriod.MONTH,
            start_date=datetime(2025, 8, 1), end_date=datetime(2025, 9, 1),
            listing_type=ListingType.SUBLET, scraped_at=datetime.utcnow()
        ),
        ...
        Listing(
            id="equiv_daily_2", url="https://test.com/d2", title="Daily 100",
            price=100.0, price_period=PricePeriod.DAY,
            start_date=datetime(2025, 8, 1), end_date=datetime(2025, 9, 1),
            listing_type=ListingType.SUBLET, scraped_at=datetime.utcnow()
        ),
        Listing(
            id="equiv_weekly_2", url="https://test.com/w2", title="Weekly 700",
            price=700.0, price_period=PricePeriod.WEEK,
            start_date=datetime(2025, 8, 1), end_date=datetime(2025, 9, 1),
            listing_type=ListingType.SUBLET, scraped_at=datetime.utcnow()
        ),
        Listing(
            id="equiv_monthly_2", url="https://test.com/m2", title="Monthly 3000",
            price=3000.0, price_period=PricePeriod.MONTH,
            start_date=datetime(2025, 8, 1), end_date=datetime(2025, 9, 1),
            listing_type=ListingType.SUBLET, scraped_at=datetime.utcnow()
        ),
        ...
        Listing(
            id="expensive_daily", url="https://test.com/exp", title="Expensive",
            price=200.0, price_period=PricePeriod.DAY,
            start_date=datetime(2025, 8, 1), end_date=datetime(2025, 9, 1),
            listing_type=ListingType.SUBLET, scraped_at=datetime.utcnow()
        ),
    ]
...
def create_simple_listing(listing_id: str, price: float, period: PricePeriod) -> Listing:
...
def create_simple_user(user_id: str, min_price: float, max_price: float, 
                      period: PricePeriod, duration_days: int) -> User:
